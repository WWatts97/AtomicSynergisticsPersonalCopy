...
namespace AtomicSynergistics.Controllers
{
    ...
    public class VendorsController : Controller
    {
        ...
        public VendorsController(AtomicSynergisticsDBContext context)
        {
            _context = context;
        }
        ...
        {
            var atomicSynergisticsDBContext = _context.Vendors.Include(v => v.Country);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'AtomicSynergisticsDBContext.Vendors'  is null.");
            }
            var vendor = await _context.Vendors.FindAsync(id);
            if (vendor != null)
            {
