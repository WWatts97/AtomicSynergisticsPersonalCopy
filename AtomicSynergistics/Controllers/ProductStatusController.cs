...
namespace AtomicSynergistics.Controllers
{
    ...
    public class ProductStatusController : Controller
    {
        ...
        public ProductStatusController(AtomicSynergisticsDBContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.ProductStatuses != null ? 
                          ...
                          Problem("Entity set 'AtomicSynergisticsDBContext.ProductStatuses'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'AtomicSynergisticsDBContext.ProductStatuses'  is null.");
            }
            var productStatus = await _context.ProductStatuses.FindAsync(id);
            if (productStatus != null)
            {
