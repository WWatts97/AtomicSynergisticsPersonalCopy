...
namespace AtomicSynergistics.Controllers
{
    ...
    public class SaleProductsController : Controller
    {
        ...
        public SaleProductsController(AtomicSynergisticsDBContext context)
        {
            _context = context;
        }
        ...
        {
            var atomicSynergisticsDBContext = _context.SaleProducts.Include(s => s.Product).Include(s => s.Sale);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'AtomicSynergisticsDBContext.SaleProducts'  is null.");
            }
            var saleProduct = await _context.SaleProducts.FindAsync(id);
            if (saleProduct != null)
            {
