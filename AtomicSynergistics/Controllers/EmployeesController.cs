...
using AtomicSynergisitcs.DATA.Models;
using Microsoft.AspNetCore.Authorization;

namespace AtomicSynergistics.Controllers
{
    [Authorize(Roles ="Admin, Accounting, Human Resources")]
    public class EmployeesController : Controller
    {
        private readonly AtomicSynergisticsDBContext _context;

        public EmployeesController(AtomicSynergisticsDBContext context)
        {
            _context = context;
        }
        ...
        {
            var atomicSynergisticsDBContext = _context.Employees.Include(e => e.Department).Include(e => e.Manager).Include(e => e.Country);
            return View(await atomicSynergisticsDBContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'AtomicSynergisticsDBContext.Employees'  is null.");
            }
            var employee = await _context.Employees.FindAsync(id);
            if (employee != null)
            {
