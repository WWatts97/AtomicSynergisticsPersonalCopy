...
namespace AtomicSynergistics.Controllers
{
    ...
    public class SalesController : Controller
    {
        ...
        public SalesController(AtomicSynergisticsDBContext context)
        {
            _context = context;
        }
        ...
        {
            var atomicSynergisticsDBContext = _context.Sales.Include(s => s.Customer).Include(s => s.Salesperson);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'AtomicSynergisticsDBContext.Sales'  is null.");
            }
            var sale = await _context.Sales.FindAsync(id);
            if (sale != null)
            {
