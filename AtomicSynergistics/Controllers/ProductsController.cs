...
namespace AtomicSynergistics.Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        public ProductsController(AtomicSynergisticsDBContext context)
        {
            _context = context;
        }
        ...
        {
            var atomicSynergisticsDBContext = _context.Products.Include(p => p.ProductStatus).Include(p => p.ProductType).Include(p => p.Vendor);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'AtomicSynergisticsDBContext.Products'  is null.");
            }
            var product = await _context.Products.FindAsync(id);
            if (product != null)
            {
