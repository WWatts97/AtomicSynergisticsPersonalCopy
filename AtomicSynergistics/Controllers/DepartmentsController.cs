...
namespace AtomicSynergistics.Controllers
{
    ...
    public class DepartmentsController : Controller
    {
        ...
        public DepartmentsController(AtomicSynergisticsDBContext context)
        {
            _context = context;
        }
        ...
        {
            var atomicSynergisticsDBContext = _context.Departments.Include(d => d.Location);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'AtomicSynergisticsDBContext.Departments'  is null.");
            }
            var department = await _context.Departments.FindAsync(id);
            if (department != null)
            {
