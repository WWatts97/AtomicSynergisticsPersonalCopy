...
namespace AtomicSynergistics.Controllers
{
    ...
    public class ProductTypesController : Controller
    {
        ...
        public ProductTypesController(AtomicSynergisticsDBContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.ProductTypes != null ? 
                          ...
                          Problem("Entity set 'AtomicSynergisticsDBContext.ProductTypes'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'AtomicSynergisticsDBContext.ProductTypes'  is null.");
            }
            var productType = await _context.ProductTypes.FindAsync(id);
            if (productType != null)
            {
